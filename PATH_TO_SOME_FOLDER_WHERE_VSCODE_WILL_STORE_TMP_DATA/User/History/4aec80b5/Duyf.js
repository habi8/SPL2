...
app.post('/addFriend', async (req, res) => {
    const { toUserName } = req.body;  // The user to send a friend request to
    ...
    try {
        ...
        const recipient = await collection.findOne({ toUserName });
        const sender = await collection.findOne({currentEmail})
        ...
        const newNotification = new notifications({
            ...
            toUserName: recipient.userName,  // Set the userName of the recipient (the one receiving the notification)
